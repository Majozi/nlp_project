...
no_top_words = st.slider("Select the Number of Top Words", min_value=5, max_value=50, value=20)
...
if uploaded_file:
   ...
   def clean_text(text, bigrams=False):
    ...
    vectorizer = CountVectorizer(max_df=10, min_df=1, token_pattern='\w+|\$[\d\.]+|\S+')
