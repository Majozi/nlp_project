...
if uploaded_file:
    ...
    if 'text' not in df.columns:
        ...
        all_stopwords = set(count_vectorizer.get_stop_words()).union(additional_stopwords)
        ...
        tokenized_feedback = [list(set([word.lower() for word in feedback.split() if word.lower() not in all_stopwords])) for feedback in feedback_text]
